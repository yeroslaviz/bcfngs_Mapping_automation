...
As we are working with `conda`, the easiest place to put it is the path of the environment. In this project, the default environment path is `/fs/gpfs41/lv07/fileset07/home/b_cox/yeroslaviz/miniconda3/envs/update_genomes`, so binaries are expected under `/fs/gpfs41/lv07/fileset07/home/b_cox/yeroslaviz/miniconda3/envs/update_genomes/bin/`.
